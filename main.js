...
form.addEventListener ('submit', (e) => {
  ...
  function firstName3 (){
    let firstName3= document.getElementById('p3Name').value;
      //const re = /^[\w ]+$/;
      for (let i=0; i<firstName3.length; i++)
      {
        if (firstName3[i] === " ")
        {
  ...
  function lastName2 (){
    ...
    for (let i=0; i<lastName2.length; i++)
    {
      if (lastName2[i] === " ")
      {
  ...
  function lastName3 (){
    ...
    for (let i=0; i<lastName3.length; i++)
    {
      if (lastName3[i] === " ")
      {
  ...
  function age2(){
    ...
    function age3(){
      ...
      document.getElementById("age3-error").innerHTML = "Age should be a number";
        ...
        document.getElementById("age3-error").innerHTML = "The passenger can't be older than 18"; 
        }else{
